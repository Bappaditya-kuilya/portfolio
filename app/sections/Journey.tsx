...
const milestones = [
  {
    ...
    period: "2021 — Present",
    description: "Pursuing B.Tech in Computer Science Engineering with focus on AI/ML systems. Maintaining CGPA of 8.11.",
    highlights: ["Dean's List", "ML Research", "Hackathon Winner"],
  },
  {
    icon: Code,
  ...
  },
  {
    ...
    period: "2023 — 2024",
    description: "Recognized for innovative solutions and rapid prototyping capabilities in competitive programming environments.",
    highlights: ["1st Place", "Innovation Award", "Best AI Solution"],
  },
  {
    icon: Briefcase,
